...
if(isset($_POST['register'])){
      ...
      if($email != $row['email']){
          ...
          mysqli_query($conn,"INSERT INTO admin (employee_id, lname, fname, initial, email,  password, code, status, date_created) VALUES ('$employee_id', '$lname', '$fname', '$initial', '$email', '$password', '$code', '$status', '$date_created')");  
