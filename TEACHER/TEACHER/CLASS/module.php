			...
			<div class="row">
				<table id="myTable" class="table table-bordered table-striped">
					...
					<tbody>
						<?php
							include_once('../../../connection/connection.php');
							$sql = "SELECT * FROM `assigned_module_student` LEFT JOIN module_list ON assigned_module_student.module_id = module_list.id WHERE assigned_module_student.assigned_id = '$user_id' AND module_list.subj_id = '$subj_id'";
