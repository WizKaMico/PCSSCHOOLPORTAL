...
<div class="container">
	<div class="row">
		<div class="col-sm-12">
			...
			<div class="row">
				<a href="#addnew" data-toggle="modal" class="btn btn-primary" style="background-color:#2c3e50; border-color:#2c3e50;"><span class="glyphicon glyphicon-plus"></span> ADD ADMIN</a>
				...
				<table id="myTable" class="table table-bordered table-striped">
					...
					<tbody>
						<?php
							...
							$sql = "SELECT * FROM admin WHERE status != 'ARCHIVE' || status != 'LOCKED'";
