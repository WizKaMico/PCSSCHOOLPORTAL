               ...
               <form action="#" method="POST">
                ...
                <?php 
                    ...
                    if(isset($_POST['update'])){
                       ...
                       $query     = mysqli_query($conn, "SELECT * FROM student WHERE  password='$password' and user_id='$user_id'");
                        ...
                        if ($num_row > 0) 
                          {     
                             $user_id = $row['user_id'];
                              mysqli_query($conn,"UPDATE student SET password='$new_pass' WHERE user_id = '$user_id'"); 
