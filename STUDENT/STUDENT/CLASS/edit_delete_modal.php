    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" name="edit" class="btn btn-success" style="background-color:#421714; border-color:#421714;"><span class="glyphicon glyphicon-check"></span> Update</button>
			</form>
            </div>
            	...
            	<div class="row form-group">
            		...
            		<div class="col-sm-10">
						<select class="form-control" name="module_id" required>
							...
							?>	
							<option value="<?php echo $xrow['mlid']; ?>"> <?php echo $xrow['subj_name']; ?> | <?php echo $xrow['mod_name']; ?></option>
						    <?php } ?>
						</select>
					</div>	
				</div>	
