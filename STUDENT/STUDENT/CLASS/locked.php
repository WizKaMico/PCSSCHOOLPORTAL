				...
				<table id="myTable" class="table table-bordered table-striped">
					...
					<tbody>
						<?php
							...
							$sql = "SELECT * FROM student LEFT join section on student.sec_id = section.section_id LEFT JOIN grade ON section.grade_id = grade.grade_id WHERE student.status = 'LOCKED'";
