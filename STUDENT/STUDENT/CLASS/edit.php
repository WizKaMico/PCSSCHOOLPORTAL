...
if(isset($_POST['edit'])){
  ...
  mysqli_query($conn,"UPDATE student SET stud_lrn='$stud_lrn', email='$email', sec_id='$sec_id', fname='$fname', lname='$lname', initial='$initial', status='$status' WHERE user_id = '$user_id'");  

     mysqli_query($conn,"UPDATE assigned_section_student SET sec_id='$sec_id', email='$email' WHERE stud_id = '$code'");

         

 require 'mailler/autoload.php';
    
      $subject = 'PCS | EMAL VERIFICATION : '.strtoupper($email).' | ACCOUNT UPDATE | '.strtoupper($status).'';
                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td>
                      ...
                      <p>WELCOME PCS | ACCOUNT UPDATED </p><br>
