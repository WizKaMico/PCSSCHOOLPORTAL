...
<div class="container">
	<div class="row">
		<div class="col-sm-12">
			...
			<div class="row">
				<a href="#addspecificsection" data-toggle="modal" class="btn btn-primary" style="background-color:#2c3e50; border-color:#2c3e50;"><span class="glyphicon glyphicon-plus"></span>ADD SECTION</a>
			</div>
			<div class="height10">
			</div>
			<div class="row">
						...
						<?php
							...
							while($row = $query->fetch_assoc()){
								...
								"<tr>
									...
									<td>
										<a href='#specific_".$row['secid']."' class='btn btn-success btn-sm' data-toggle='modal' style='background-color:#2c3e50; border-color:#2c3e50;'><span class='glyphicon glyphicon-edit'></span></a>
