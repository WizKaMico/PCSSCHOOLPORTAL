						...
						<?php
							...
							while($row = $query->fetch_assoc()){
								...
								"<tr>
									...
									<td>
										<a href='#subj_".$row['subj_id']."' class='btn btn-success btn-sm' data-toggle='modal' style='background-color:#2c3e50; border-color:#2c3e50;'><span class='glyphicon glyphicon-edit'></span></a>
											<a href='#delete_".$row['subj_id']."' class='btn btn-success btn-sm' data-toggle='modal' style='background-color:#2c3e50; border-color:#2c3e50;'><span class='glyphicon glyphicon-trash'></span></a>
