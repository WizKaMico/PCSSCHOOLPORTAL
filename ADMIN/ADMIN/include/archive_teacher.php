            ...
            <div class="tab">
              ...
              <button class="tablinks" onclick="openCity(event, 'LOCKED')">LOCKED</button>
                ...
                <div class="card-body">
                 ...
                 <h5>ARCHIVE TEACHER</h5>   
                  <iframe src="TEACHER/archive.php" style="width:100%; height:600px; border:none;"></iframe>
                 </div>   
       
                 <div class="tabcontent" id="LOCKED" style="display:none;">
                  <h5>LOCKED TEACHER</h5>      
                  <iframe src="TEACHER/locked.php" style="width:100%; height:600px; border:none;"></iframe>
                 </div> 
            </div>
          </div>
