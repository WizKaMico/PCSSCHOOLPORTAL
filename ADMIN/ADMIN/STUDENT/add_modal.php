    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <center><h4 class="modal-title" id="myModalLabel">CREATE NEW STUDENT</h4></center>
            </div>
			...
			<form method="POST" action="add.php" enctype="multipart/form-data">
				<div class="row form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" name="stud_lrn" value="<?php echo rand(666666,999999); ?>" required="" readonly="">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
